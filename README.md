...
The deck starts with one page. Navigate forward from the final page with the next control, a forward key, or a leftward swipe to create another blank page; the accumulated page count is restored in this browser on reload.
